...
//		this.disable();
	...
	protected double returnPIDInput() {
		...
		SmartDashboard.putNumber("DB/Slider 2",velocity*1000);
		double accel = 1000 * 12 *1000*((velocity- pastVelocitydd)/(currentTime - pastOneTime)) ;
		
		if(velocity*1000<-2){
			accelCum+=accel;
			i++;
		}
		SmartDashboard.putString("DB/String 3","AC:" + accelCum/i);
		
		pastVelocitydd=pastVelocity;
