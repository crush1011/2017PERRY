...
public class AutonStraightMeasurement extends PIDSubsystem implements Runnable {
	...
	public AutonStraightMeasurement(double distance, double speed) {
		super(2.0, 0, 0);
	...
	public AutonStraightMeasurement(double distance, double speed, double angle) {
		super(1.0, 0, 0);
		this.setAbsoluteTolerance(2);
		this.getPIDController().setContinuous(true);
		this.setInputRange(0, 360);
	...
	public synchronized void run() {
		...
		if (speed >= 0) {
			while ((driveTrain.leftDistanceTravelled() - initialDistanceLeft + 
				...
				if(!slowed && (driveTrain.leftDistanceTravelled() - initialDistanceLeft + 
